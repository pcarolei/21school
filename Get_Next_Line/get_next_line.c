...
/*   Updated: 2019/08/19 11:12:49 by pcarolei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.h"

t_fd_list	*create_node(int fd)
{
	t_fd_list	*new;
...
t_fd_list	*find_node_by_fd(const int needed_fd, t_fd_list *fd_list)
{
	t_fd_list	*ptr;
...
int			split_str_by_newline(t_fd_list *cur_node, char **line)
{
	char	*pos;
